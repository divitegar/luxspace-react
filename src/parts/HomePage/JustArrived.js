    ...
    .map((_, index) => {
      return (
        <div className="px-4 relative card group" key={index}>
          <div
            className="rounded-xl bg-gray-200 overflow-hidden card-shadow relative"
              ...
              return (
                <div key={item?.id} className="px-4 relative card group">
                  <div
                    ...
                    style={{ width: 287, height: 386 }}
                  >
                    <div className="absolute opacity-0 group-hover:opacity-80 transition duration-200 flex items-center justify-center w-full h-full bg-black bg-opacity-35">
